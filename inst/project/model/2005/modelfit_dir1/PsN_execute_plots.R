...
pdf.title <- 'execute diagnostic plots 2005.ctl'
working.directory<-'/home/tbergsma/project/nonmemica/inst/project/model/2005/modelfit_dir1/'
raw.results.file <- 'raw_results_2005.csv'
model.directory<-'/home/tbergsma/project/nonmemica/inst/project/model/2005/'
model.filename<-'2005.ctl'
