...
#Created 2017-10-05 at 14:04

rplots.level <- 1
xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots 2006.ctl'
working.directory<-'/home/tbergsma/project/nonmemica/inst/project/model/2006/modelfit_dir1/'
raw.results.file <- 'raw_results_2006.csv'
model.directory<-'/home/tbergsma/project/nonmemica/inst/project/model/2006/'
model.filename<-'2006.ctl'
